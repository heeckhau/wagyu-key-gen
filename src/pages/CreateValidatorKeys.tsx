...
const CreateValidatorKeys = () => {
  ...
  const createKeys = () => {
    ...
    // The backend converts the amount to gwei exactly (no floating point) and applies the
    // network multiplier (Gnosis chains deposit GNO, which counts 32x).
    const amountString = String(amount);

    eth2Deposit.generateKeys(
      mnemonic,
      index,
      amountString,
      numberOfKeys,
